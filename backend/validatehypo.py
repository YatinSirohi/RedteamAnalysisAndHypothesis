...
def extract_keywords(text):
    ...
    extracted_keywords = {
        word for word in meaningful_words if word in cyber_attack_keywords
    }
            ...
            attack_entry["Exploits"].append(
                {
                    ...
                    "Exploit Description": exploit.get(
                        "description", "No description available"
                    ),
