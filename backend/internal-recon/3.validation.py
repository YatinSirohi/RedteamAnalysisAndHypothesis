...
def main():
    hypothesis_file = '2.2.hypotheses_output.json'  # Path to the hypothesis file
    mitre_event_id_file = '3.1.MITREattack_eventid.json'  # Path to the MITRE event ID file
