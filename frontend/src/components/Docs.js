...
const Docs = () => {
  ...
  <h2 style={{ color: " rgb(211, 17, 43)", fontSize: "24px",  textAlign: "center", marginBottom: "20px" }}>Setup Instructions</h2>
  <ol style={{ paddingLeft: "20px" }}>
    ...
    <li style={{ marginBottom: "15px" }}>
      ...
      <pre style={{ backgroundColor: "#e0e0e0", padding: "10px", borderRadius: "5px" }}>
        <code>pip install nmap json nvdlib pyxploitdb flask flask_cors nltk</code>
      </pre>
    </li>
  ...
  <h3 style={{ color: " rgb(211, 17, 43)", fontSize: "24px", marginTop: "30px" }}>Troubleshooting</h3>
